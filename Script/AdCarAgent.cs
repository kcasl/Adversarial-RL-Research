...
public class AdCarAgent : Agent
{
    Rigidbody rBody;
    public Transform Target;
    public AdversarialAgent AdversarialAgent;
    ...
    private void OnCollisionEnter(Collision coll)
    {
        ...
        {
            AdversarialAgent.SuccessBlocking();
            SetReward(-2.5f);
            EndEpisode();
        ...
        {
            AdversarialAgent.SuccessBlockingByWall();
            SetReward(-2f);
            EndEpisode();
            StartCoroutine(RevertMaterial(failMAT));
        }
